...
<head>
    ...
    <title>OPPORTUNITÉ | Inscription</title>
...
<?php
          ...
          if(isset($_POST["reg"])){
              ...
              echo '<p style="color:red"> Cet e-mail est déjè utilisé </p>';  

              }else  if(mysqli_num_rows($selectusername)){

              echo ' <p style="color:red">Ce pseaudo est déjà utilisé  </p>';  
             
                      }
                else if ($user->password === $confirmpassword) {


                  $query = "INSERT into `user` (username, password, email, firstname, lastname, phone , role)
                            VALUES ('$user->username', '$hashedpassword', '$user->email' , '$user->firstname' , '$user->lastname','$user->phone', 'user')";
    ...
    <p class="h4 mb-4">Créez un compte !</p>
    ...
    <input type="text" name="username" class="form-control" placeholder="Pseaudo*" aria-describedby="defaultRegisterFormPhoneHelpBlock" required><br>
    <!-- E-mail -->
    <input type="email" name="email" class="form-control mb-4" placeholder="E-mail*"> <br>
    ...
    <!-- Phone number -->
    <input type="text" name="phone" class="form-control" placeholder="Téléphone*" aria-describedby="defaultRegisterFormPhoneHelpBlock" required><br>
   

    

    <!-- Sign up button -->
    <button class="btn btn-deep-orange" type="submit" name="reg">S'inscrire !</button>


    <hr>

    <!-- Terms of service -->
    <p> En vous inscrivant, vous acceptez nos <a href="condition.php" target="_blank">Conditions Générales</a>

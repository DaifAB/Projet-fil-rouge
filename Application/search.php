...
<head>
    ...
    <title>OPPORTUNITÉ | Rechercher</title>
        ...
        <div class="row cat-row">
         ...
         <?php 
            if(isset($_POST['search-submit'])){
                ...
                $sqlsearch = "SELECT announcement.*, domain.name FROM announcement JOIN domain ON announcement.dom_id=domain.id WHERE title LIKE '%$search%' OR content LIKE '%$search%' OR localisation LIKE '%$search%' or name LIKE '%$search%'";
                ...
                <hr class="rounded">
                    ...
                    <?php
                        ...
                        <a href="announcement.php?ad_id=<?php echo $searchblock['id'] ?>" style="color : black">
                          <div class="row ad-rows">
                              <div class="col-sm-4 col-12 adimg">
                                <img src="upload/ad/<?php echo $searchblock['img'] ?>" alt="">
                              </div>
                              <div class="col-sm-8 col-12">
                                <h3><?php echo $searchblock['title'] ?></h3>
                               <div> <i class="far fa-folder-open"></i><p> <?php echo $searchblock['name'] ?></p></div>
                               <div><i class="fas fa-map-marker-alt"></i><p> <?php echo $searchblock['localisation'] ?></p></div> 
                               <div> <i class="far fa-clock"></i> <p> <?php echo $searchblock['date'] ?></p></div>

...
if(!isset($_SESSION["username"])){
  ...
  $adId = $_GET['ad_id'];
  $sqlad = "SELECT * FROM announcement WHERE id = $adId";
...
<head>
    ...
    <title>OPPORTUNITÉ | Modifier</title>
...
<!--/.Navbar -->
        <div class="slogan">
        <center><h1 class="slogan">Modifier une annonce !</h1></center>
        </div>
            ...
            <div class="row row-addad">
                <div class="col">
                 <!-- Default form contact -->
                        ...
                        <label>Titre:</label>
                        <!-- title -->
                        <input type="text" id="defaultContactFormName" class="form-control mb-4" placeholder="Titre*" name="title" value="<?php echo $ad['title'] ?>">

                        <label>Description :</label>
                        <!-- desciption -->
                        <div class="form-group">
                            <textarea class="form-control rounded-0" id="exampleFormControlTextarea2" rows="3" placeholder="Description" name="desc"><?php echo $ad['content'] ?></textarea>
                        </div>
                        ...
                        <!-- add button -->
                        <button class="btn btn-info btn-deep-orange" type="submit" name="update">Modifier</button>
